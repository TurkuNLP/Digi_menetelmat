...
pos_not_to_keep = []  # tähän voi lisätä sanaluokkia, joita ei halua ottaa mukaan analyysiin. esim. [u"PUNCT, u"CONJ"]
          ...
          try:
              if  line[1].strip() not in search_words:
                  if line[2].strip() not in pos_not_to_keep:
                      comment.append(line[1].strip()) # tähän voi 1:sen tilalle laittaa 0:n, jos haluaa koittaa, mitä lemman vaihtaminen juoksevaksi sanaksi vaikuttaa, tai numeron 3, jos haluaa koittaa, miten luokittelija oppii tunnistamaan tekstit pelkkien sanaluokkien perusteella
          except: continue 
